...
const construccionCivil = [
  ...
  { title: 'CANALIZACIONES', href: '/control-de-erosion/canalizaciones', imgSrc: 'https://tumuro.com/media/insfraestructura-urbana/grid-insfraestructura-urbana/canalizaciones-cda.webp' },
