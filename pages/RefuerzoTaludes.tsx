                ...
                <div className="relative max-w-5xl w-full max-h-[85vh]">
                    <AnimatePresence initial={false}>
                        <motion.img
                            ...
                            alt={`Galería de refuerzo de talud ${currentIndex + 1}`}
                        />
                    </AnimatePresence>
                </div>
...
// --- Main Page Component ---
const RefuerzoTaludes: React.FC = () => {
  ...
  return (
    <>
      ...
      <meta name="description" content="Sistemas de contención reforestables para la estabilización de taludes y terraplenes mediante geomallas y tecnología verde." />
                        ...
                        <div className="space-y-6 text-lg text-gray-700 leading-relaxed pt-4 pb-8 border-t border-gray-200 mt-4">
                           ...
                           <div>
                               ...
                               <ul className="list-disc list-inside space-y-2 pl-4 mt-4">
                                   <li>La disponibilidad de los materiales geosinteticos que los conforman y de los equipos y maquinarias especializadas para su construcción.</li>
                                   <li>En muchos casos no se requiere de material de préstamo, debido a que se puede reutilizar el material fallado del mismo derrumbe o deslizamiento.</li>
                                   <li>Son considerados como la solución mas económica por no requerir de mano de obra calificada.</li>
                                   <li>Su construcción se logra en un excelente tiempo.</li>
                                   <li>Su gran ventaja en cuanto al bajo impacto ambiental, en vista que su fachada resulta completamente reforestada, armonizando ecológicamente con el medio ambiente.</li>
                               </ul>
                           </div>
                        </div>
                    </motion.div>
...
export default RefuerzoTaludes;
