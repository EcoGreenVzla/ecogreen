...
const GridIndustriaPetroleoGas: React.FC = () => {
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <h3 className="text-3xl font-bold text-ecogreen-blue mb-2 uppercase text-left">Soluciones para el Sector Energético</h3>
...
export default GridIndustriaPetroleoGas;